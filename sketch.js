//Declaración de los objetos del módulo Matter.js
const Engine = Matter.Engine;
const World = Matter.World;
const Bodies = Matter.Bodies;

//Declración de variables para el video juego
...
//Mëtodo que carga todas las imágenes
function preload(){
...
//Mëtodo que inicializa los elementos del video juego
function setup(){
...
//Método que Dibuja cada elemento
function draw(){
    ...
    //Se destruyen los rayos para que no se queden
